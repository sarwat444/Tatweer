                            ...
                            <table class="table eTable eTable-2 print-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ get_phrase('Verified') }}</th>
                                            ...
                                            <td>
                                                <div class="eSwitches">
                                                    <div class="form-check form-switch">
                                                        <input
                                                            onchange="actionTo('{{ route('admin.student.verified_student', ['id' => $row->id]) }}'); pageSwitcher(this);"
                                                            class="form-check-input form-switch-medium " name="home_page" type="checkbox" @if ($row->verified_student == 1) checked  @endif>
                                                    </div>
                                                </div>
                                            </td>
