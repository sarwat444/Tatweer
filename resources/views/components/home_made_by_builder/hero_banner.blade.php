...
<section class="banner-wraper mt-0 pt-5 pb-5 background-overlay">
    <div class="container">
                ...
                <div class="col-md-6 order-2 order-md-1 ">
                    <div class="banner-content">
                        ...
                        <div class="banner-btn">
                            <a href="{{ route('courses') }}" class="eBtn gradient_2 builder-editable" builder-identity="6">{{ get_phrase("Get Started") }}</a>
