                            ...
                            <div class="accordion-body">
                                <ul class="lesson-list course_list">
                                    ...
                                    @foreach ($lessons as $lesson)
                                        <li>
                                            <a href="{{ $course_details->is_paid ? 'javascript:: void(0);' : route('course.player', [$course_details->slug,$lesson->id]) }}" class="d-flex justify-content-between align-items-center">
                                                <p class="d-flex">
